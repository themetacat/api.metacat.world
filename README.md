...
###### URL
> https://www.metacat.world/api/v1/get\_carousel\_list
...
###### 接口示例
> curl -s 'https://www.metacat.world/api/v1/get\_carousel\_list' | jq .
...
###### URL
> https://www.metacat.world/api/v1/get\_cv\_parcel\_list
...
###### 接口示例
> curl -s 'https://www.metacat.world/api/v1/get\_cv\_parcel\_list' | jq . 
...
###### URL
> https://www.metacat.world/api/v1/get\_cv\_event\_list
...
###### 接口示例
> curl -s 'https://www.metacat.world/api/v1/get\_cv\_event\_list' | jq . 
...
###### URL
> https://www.metacat.world/api/v1/get\_dcl\_parcel\_list
...
###### 接口示例
> curl -s 'https://www.metacat.world/api/v1/get\_dcl\_parcel\_list' | jq . 
...
###### URL
> https://www.metacat.world/api/v1/get\_dcl\_event\_list
